...
css_file_path = r"C:\Data Science\data\chicago-crime-property-analysis\chicago-crime-property-analysis\Israel\app\style.css"
...
def load_data_head(filepath):
    ...
    return df
df = load_data_head(r'C:\Data Science\data\chicago-crime-property-analysis\chicago-crime-property-analysis\Israel\app\resources\data\df_head.csv')
